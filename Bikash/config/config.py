...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/arvind0251/Bgtplayer")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ROC_KY098")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/ROC_KY098")
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/9ef9892f37cbea63ba6e5.jpg")
...
if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://te.legra.ph/file/9ef9892f37cbea63ba6e5.jpg"
